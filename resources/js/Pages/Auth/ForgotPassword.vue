    ...
    <div class="min-h-screen flex items-center justify-center bg-gray-50 p-6 font-sans">
        <div class="max-w-md w-full space-y-8 bg-white p-10 rounded-3xl shadow-xl border border-gray-100">
            ...
            <div class="text-center">
                ...
                <h2 class="mt-6 text-2xl font-bold text-gray-900">Password Recovery</h2>
                <p class="mt-1 text-gray-500">Recover your admin or customer account</p>
            </div>
            ...
            <form v-if="!otpSent" class="mt-8 space-y-5" @submit.prevent="submitIdentifier">
                <div>
                    <label for="identifier" class="block text-sm font-semibold text-gray-700 mb-2">Email Address or Mobile Number</label>
                    <div class="relative">
                ...
                <p class="text-center text-sm text-gray-500">
                    Remembered password? 
                    <Link href="/login" class="text-blue-600 font-bold hover:underline">Login here</Link>
                </p>
            </form>
            ...
            <form v-else class="mt-8 space-y-5" @submit.prevent="submitReset">
                <div class="space-y-4">
                    <div>
                        <label for="otp" class="block text-sm font-semibold text-gray-700 mb-2">Verification Code (OTP)</label>
                        <div class="relative">
