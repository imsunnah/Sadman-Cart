        ...
        <div class="mb-8 bg-white p-4 rounded-2xl border border-slate-200 flex flex-wrap items-center justify-between gap-4">
            <div class="flex flex-wrap items-center gap-2">
                ...
                >
                    ...
                    <span class="ml-1.5 px-2 py-0.5 text-[9px] font-black rounded-full" :class="currentTab === 'all' ? 'bg-white/20 text-white' : 'bg-slate-200 text-slate-700'">{{ counts.all }}</span>
                </Link>
                ...
                <Link 
                    ...
                    :class="[
                        ...
                        ? 'bg-[#FF6600] text-white border-[#FF6600] shadow-md shadow-orange-500/10' 
                        : 'bg-slate-50 text-slate-600 border-slate-100 hover:bg-slate-100'
                    ]"
                >
                    <TrendingDown class="w-3.5 h-3.5" />
                    <span>Low Stock (< 10)</span>
                    <span class="ml-1.5 px-2 py-0.5 text-[9px] font-black rounded-full" :class="currentTab === 'low_stock' ? 'bg-white/20 text-white' : 'bg-slate-200 text-slate-700'">{{ counts.low_stock }}</span>
                </Link>
